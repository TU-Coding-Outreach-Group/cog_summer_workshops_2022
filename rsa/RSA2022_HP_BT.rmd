...
Not sure if I actually updated this part so please check the chunk below and see if it matches the solution you have:
``` {r, include = FALSE}
...
```
![](figures/EncodingRSM_sub-660_FFA.pdf)
...
![](figures/EncodingRSM_GroupLevel_FFA.pdf)
